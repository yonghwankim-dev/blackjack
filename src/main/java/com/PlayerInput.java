...
public class PlayerInput {
    ...
    public int inputChose(User player) {
        String input;
        while(true){
    ...
    public int inputInitialPoint(String name) {
        String input;
        while(true){
    ...
    public int inputBatting(Player player) {
        String input;
        while(true){
            ...
            try{
                input = br.readLine();
                if(!GameInputValidate.validatePlayerPoint(input)) throw new PointNumberFormatException();
                if(!isEnoughBatting(player, toInt(input))) throw new PointBattingNotEnoughException(player);
                break;
